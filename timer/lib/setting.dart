    ...
    return Container(
      child: GridView.count(
        ...
        children: <Widget>[
          ...
          Text(''),
          Text(''),
          SettingsButton(Color(0xff455A64), "-", 30, -1, WORKTIME, updateSetting ),
          TextField(
              controller: txtWork,
              style: textStyle,
              textAlign: TextAlign.center,
              keyboardType: TextInputType.number),
          SettingsButton(Color(0xff009688), "+", 30, 1, WORKTIME,updateSetting),
          Text('Short', style: textStyle),
          Text(''),
          Text(''),
          SettingsButton(Color(0xff455A64), "-", 30, -1, SHORTBREAK,
updateSetting),
          TextField(
              style: textStyle,
              controller: txtShort,
              textAlign: TextAlign.center,
              keyboardType: TextInputType.number),
          SettingsButton(Color(0xff009688), "+", 30, 1, SHORTBREAK,
updateSetting),
          Text(
            'Long',
            style: textStyle,
          ...
          Text(''),
          Text(''),
          SettingsButton(Color(0xff455A64), "-", 30, -1,LONGBREAK,
updateSetting),
          ...
          TextField(
              ...
              textAlign: TextAlign.center,
              keyboardType: TextInputType.number),
         SettingsButton(Color(0xff009688), "+", 30, 1, LONGBREAK,
updateSetting),
        ],
